...
export type FlashDeal = { discountPct: number; reason: string };
...
export type Activity = {
  ...
  imageKeywords?: string; // Override for image search query
  flashDeal?: FlashDeal;  // If present, real discount applied everywhere
  lightning?: boolean;    // If true, eligible for Lightning Match groups
};
...
const a = (
  ...
  weather: WeatherSensitivity, opts: ActOpts = {},
): Activity => ({
...
export const ACTIVITIES: Activity[] = [
  ...
  a("mrk-1", "Cours de cuisine marocaine en riad", "marrakech", "Gastronomie",
    ...
    { imageKeywords: "moroccan cooking class tajine riad marrakech", lightning: true }),
  a("mrk-2", "Montgolfière au lever du soleil", "marrakech", "Aventure",
    ...
    { imageKeywords: "hot air balloon sunrise atlas mountains marrakech",
      flashDeal: { discountPct: 25, reason: "Créneaux invendus aube" } }),
  a("mrk-3", "Quad dans le désert d'Agafay", "marrakech", "Aventure",
    ...
    { imageKeywords: "quad bike agafay desert morocco",
      flashDeal: { discountPct: 30, reason: "Places dernière minute" }, lightning: true }),
  a("mrk-4", "Hammam royal & gommage rose", "marrakech", "Bien-être",
    ...
    { imageKeywords: "moroccan hammam spa rose petals" }),
  a("mrk-5", "Visite guidée Médina & Souks", "marrakech", "Culture",
    ...
    { imageKeywords: "marrakech medina souk jemaa el-fna",
      flashDeal: { discountPct: 20, reason: "Groupe ouvert ce jour" }, lightning: true }),
  a("mrk-6", "Atelier poterie & zellige", "marrakech", "Artisanat",
    ...
    { imageKeywords: "moroccan pottery zellige craft workshop" }),
  a("mrk-7", "Soirée gala Chez Ali", "marrakech", "Spectacle",
    ...
    { imageKeywords: "moroccan fantasia berber horsemen night show",
      flashDeal: { discountPct: 35, reason: "Tables disponibles ce soir" }, lightning: true }),
  ...
  a("csa-1", "Visite Mosquée Hassan II + skip-line", "casablanca", "Culture",
    ...
    { imageKeywords: "hassan ii mosque casablanca architecture" }),
  a("csa-2", "Yacht privé Côte Atlantique", "casablanca", "Bien-être",
    ...
    { imageKeywords: "luxury yacht atlantic ocean sunset morocco" }),
  a("csa-3", "Food tour street-food à Derb Omar", "casablanca", "Gastronomie",
    ...
    { imageKeywords: "moroccan street food casablanca medina",
      flashDeal: { discountPct: 30, reason: "Dernières places ce soir" }, lightning: true }),
  a("csa-4", "Escape Game Casa Mystère", "casablanca", "Loisirs",
    ...
    { imageKeywords: "escape game puzzle room moorish palace",
      flashDeal: { discountPct: 40, reason: "Créneau libre maintenant" }, lightning: true }),
  a("csa-5", "Spa Four Seasons – journée détente", "casablanca", "Bien-être",
    ...
    { imageKeywords: "luxury hotel spa pool wellness morocco" }),
  ...
  a("rba-1", "Visite Kasbah des Oudayas + thé", "rabat", "Culture",
    ...
    { imageKeywords: "kasbah oudayas rabat blue white walls" }),
  a("rba-2", "Atelier calligraphie arabe", "rabat", "Artisanat",
    ...
    { imageKeywords: "arabic calligraphy ink workshop morocco",
      flashDeal: { discountPct: 25, reason: "Atelier samedi disponible" } }),
  a("rba-3", "Balade à vélo Bouregreg", "rabat", "Sport",
    ...
    { imageKeywords: "ebike bouregreg river rabat morocco",
      flashDeal: { discountPct: 30, reason: "Places dernière minute" }, lightning: true }),
  a("rba-4", "Dîner gastronomique Dar Naji", "rabat", "Gastronomie",
    ...
    "Dar Naji", 4, "indoor",
    { imageKeywords: "moroccan fine dining riad rabat" }),
  ...
  a("tng-1", "Excursion Cap Spartel & Grottes Hercule", "tanger", "Aventure",
    ...
    { imageKeywords: "cap spartel hercules cave tangier morocco",
      flashDeal: { discountPct: 25, reason: "Places ce week-end" }, lightning: true }),
  a("tng-2", "Sunset cruise dans le détroit", "tanger", "Bien-être",
    ...
    { imageKeywords: "sailing boat sunset strait gibraltar tangier" }),
  ...
  a("tng-4", "Plongée à la grotte sous-marine", "tanger", "Sport",
    ...
    { imageKeywords: "scuba diving underwater morocco mediterranean", lightning: true }),
  a("tng-5", "Balade en bateau Cap Spartel", "tanger", "Aventure",
    ["#MomentMagique", "#AventureLudique"], "2h", 280, 4.7, 92, img.yacht,
    "Petit bateau privatisé pour observer dauphins et falaises.",
    "Skipper local, eau et fruits secs, gilets fournis. Idéal en famille.",
    "Tanger Boat Trips", 10, "outdoor",
    { imageKeywords: "boat trip cap spartel cliffs dolphins tangier",
      flashDeal: { discountPct: 30, reason: "Sortie matin libre" }, lightning: true }),
  a("tng-6", "Soirée jazz au Café Hafa", "tanger", "Spectacle",
    ["#AmbianceFestive", "#MomentMagique"], "3h", 220, 4.8, 167, img.fesNight,
    "Concert acoustique sur la falaise mythique de Tanger.",
    "Thé à la menthe, vue sur le détroit, musiciens locaux et invités.",
    "Hafa Jazz Club", 40, "outdoor",
    { imageKeywords: "cafe hafa tangier sea view rooftop tea",
      lightning: true }),
  a("tng-7", "Cours de surf à Plage Achakar", "tanger", "Sport",
    ["#BesoinDeTranspirer", "#AventureLudique"], "2h", 260, 4.7, 81, img.surf,
    "Initiation surf face à l'Atlantique sauvage.",
    "Combinaison, planche, moniteur ISA, photos vidéo.",
    "Achakar Surf School", 8, "outdoor",
    { imageKeywords: "surf beach atlantic morocco achakar tangier",
      flashDeal: { discountPct: 30, reason: "Vagues idéales ce matin" }, lightning: true }),
  a("tng-8", "Atelier calligraphie arabe en Médina", "tanger", "Artisanat",
    ["#TraditionVivante", "#DéconnexionTotale"], "2h", 230, 4.8, 64, img.calligraphy,
    "Initiation à l'écriture maghrébine dans un atelier centenaire.",
    "Encre, papier, calame fournis. Repartez avec votre œuvre encadrée.",
    "Atelier Al Hamra", 6, "indoor",
    { imageKeywords: "arabic calligraphy artist morocco workshop ink" }),
  a("tng-9", "Excursion Chefchaouen depuis Tanger", "tanger", "Aventure",
    ["#MomentMagique", "#TraditionVivante"], "Journée", 420, 4.9, 312, img.chefchaouen,
    "Journée complète dans la Perle Bleue depuis Tanger.",
    "Transport AC, guide, temps libre dans la médina, déjeuner local.",
    "Rif Day Trips", 18, "outdoor",
    { imageKeywords: "chefchaouen blue city street morocco",
      flashDeal: { discountPct: 25, reason: "Bus du dimanche" }, lightning: true }),
  a("tng-10", "Hammam traditionnel Marshan", "tanger", "Bien-être",
    ["#DéconnexionTotale", "#TraditionVivante"], "1h30", 180, 4.6, 142, img.hammam,
    "Hammam authentique de quartier, gommage savon noir.",
    "Vapeur, gommage kessa, masque ghassoul, thé à la menthe.",
    "Hammam Marshan", 1, "indoor",
    { imageKeywords: "moroccan traditional hammam steam tangier" }),
  ...
  a("fez-1", "Tour artisans tanneurs Chouara", "fes", "Artisanat",
    ...
    { imageKeywords: "chouara tannery fes morocco leather" }),
  a("fez-2", "Atelier zellige avec maître artisan", "fes", "Artisanat",
    ...
    { imageKeywords: "zellige tile art workshop fes morocco",
      flashDeal: { discountPct: 20, reason: "Atelier ouvert demain" } }),
  a("fez-3", "Cours cuisine fassia chez l'habitant", "fes", "Gastronomie",
    ...
    { imageKeywords: "moroccan cooking class pastilla fes family", lightning: true }),
  a("fez-4", "Visite nocturne Médina + dîner riad", "fes", "Culture",
    ...
    { imageKeywords: "fes medina night lanterns riad morocco",
      flashDeal: { discountPct: 25, reason: "Tables ce vendredi" } }),
  ...
  a("chf-1", "Photo tour la perle bleue", "chefchaouen", "Culture",
    ...
    { imageKeywords: "chefchaouen blue city photography street", lightning: true }),
  a("chf-2", "Randonnée Akchour cascades", "chefchaouen", "Sport",
    ...
    { imageKeywords: "akchour waterfall hike rif mountains morocco",
      flashDeal: { discountPct: 30, reason: "Groupe samedi ouvert" }, lightning: true }),
  a("chf-3", "Atelier teinture indigo", "chefchaouen", "Artisanat",
    ...
    { imageKeywords: "indigo dye textile morocco craft",
      flashDeal: { discountPct: 25, reason: "Atelier matin disponible" } }),
  a("chf-4", "Yoga sunrise sur les toits bleus", "chefchaouen", "Bien-être",
    ...
    { imageKeywords: "rooftop yoga sunrise blue city morocco", lightning: true }),
  ...
  a("agd-1", "Cours surf débutants à Taghazout", "taghazout", "Sport",
    ...
    { imageKeywords: "taghazout surf beach atlantic morocco",
      flashDeal: { discountPct: 25, reason: "Vagues idéales aujourd'hui" }, lightning: true }),
  a("agd-2", "Excursion Paradise Valley", "agadir", "Aventure",
    ...
    { imageKeywords: "paradise valley natural pools atlas morocco", lightning: true }),
  a("agd-3", "Pêche en haute mer", "agadir", "Sport",
    ...
    { imageKeywords: "deep sea fishing boat atlantic morocco",
      flashDeal: { discountPct: 30, reason: "Sortie demain matin" } }),
  a("agd-4", "Spa marin & thalasso Sofitel", "agadir", "Bien-être",
    ...
    { imageKeywords: "thalasso spa beachfront luxury morocco" }),
  ...
  a("ess-1", "Cours kitesurf à Essaouira", "essaouira", "Sport",
    ...
    { imageKeywords: "kitesurf essaouira beach wind morocco", lightning: true }),
  a("ess-2", "Balade dromadaire sur la plage", "essaouira", "Aventure",
    ...
    { imageKeywords: "camel ride beach sunset essaouira morocco",
      flashDeal: { discountPct: 30, reason: "Sortie sunset libre" }, lightning: true }),
  a("ess-3", "Atelier marqueterie thuya", "essaouira", "Artisanat",
    ...
    { imageKeywords: "thuya wood marquetry essaouira morocco craft" }),
  a("ess-4", "Dégustation poisson port", "essaouira", "Gastronomie",
    ...
    { imageKeywords: "essaouira fish market grilled seafood port morocco",
      flashDeal: { discountPct: 25, reason: "Pêche fraîche du jour" } }),
  ...
  a("mrz-1", "Bivouac de luxe désert Merzouga", "merzouga", "Aventure",
    ...
    { imageKeywords: "merzouga sahara luxury camp erg chebbi dunes night", lightning: true }),
  a("mrz-2", "Balade dromadaire 1h coucher soleil", "merzouga", "Aventure",
    ...
    { imageKeywords: "camel caravan dunes sunset sahara morocco",
      flashDeal: { discountPct: 30, reason: "Caravane ce soir" }, lightning: true }),
  a("mrz-3", "Sandboard sur les dunes", "merzouga", "Sport",
    ...
    { imageKeywords: "sandboard dunes sahara sport morocco",
      flashDeal: { discountPct: 35, reason: "Session après-midi" } }),
  ...
  a("orz-1", "Visite Aït Benhaddou + studios cinéma", "ouarzazate", "Culture",
    ...
    { imageKeywords: "ait benhaddou kasbah unesco morocco", lightning: true }),
  a("orz-2", "4x4 vallée des roses & Dadès", "ouarzazate", "Aventure",
    ...
    { imageKeywords: "dades gorge 4x4 atlas morocco" }),
  ...
  a("mkn-1", "Visite Volubilis romaine + Moulay Idriss", "meknes", "Culture",
    ...
    { imageKeywords: "volubilis roman ruins morocco",
      flashDeal: { discountPct: 25, reason: "Sortie samedi" } }),
  a("mkn-2", "Dégustation vins Meknès", "meknes", "Gastronomie",
    ...
    { imageKeywords: "vineyard wine tasting meknes morocco" }),
  ...
  a("tet-1", "Médina UNESCO de Tétouan", "tetouan", "Culture",
    ...
    { imageKeywords: "tetouan medina andalusian morocco unesco" }),
  ...
  a("ifr-1", "Ski station Michlifen Ifrane", "ifrane", "Sport",
    ...
    { imageKeywords: "michlifen ski resort ifrane morocco snow" }),
  a("ifr-2", "Forêt cèdres & singes Magot", "ifrane", "Aventure",
    ...
    { imageKeywords: "ifrane cedar forest barbary macaque morocco",
      flashDeal: { discountPct: 20, reason: "Sortie dimanche" }, lightning: true }),
];
...
export function getEffectivePrice(activity: Activity): number {
  if (!activity.flashDeal) return activity.price;
  return Math.round(activity.price * (1 - activity.flashDeal.discountPct / 100));
}

export function hasFlashDeal(activity: Activity): boolean {
  return !!activity.flashDeal;
}

export function isLightning(activity: Activity): boolean {
  return activity.lightning === true;
}
